  ...
  return (
    <section id="schedule" className="relative bg-background px-6 py-16 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl">
        {/* Header with optional circle motif image - Right aligned to match hero */}
        <div className="mb-16 text-right pr-6 md:pr-12">
          {headerImageUrl && (
            <div className="relative ml-auto mb-8 w-32 h-32 md:w-40 md:h-40">
