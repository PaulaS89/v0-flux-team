          ...
          {speakersList.map((speaker, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 bg-background border-t border-muted-foreground/20 rounded-t-2xl p-4 flex flex-col translate-y-full group-hover:translate-y-0 transition-transform duration-700 ease-out shadow-[0_-10px_40px_rgba(0,0,0,0.3)]">
                  {/* Talk time badge */}
                  {speaker.talkTime && (
